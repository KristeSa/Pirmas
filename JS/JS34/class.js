...
const isValidPostcode = postCode => /^\d{5}|[0-9]{3}[A-Za-z]{2}$/.test(postCode);
...
const addNumberSeven = array => array.map(element => element.endsWith('7') ? element : element.concat('7'))
